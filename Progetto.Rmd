...
- "- all freq.csv", contiene come colonne la frequenza di tutti i lemmi in ogni opera letteraria o autore 
...
- "- similarity matrix.csv", contiene la "differe" tra opere o autori, calcolata come la distanza del coseno tra tutte le colonne di "- all perc.csv"
